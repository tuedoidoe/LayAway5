...
if check_password():
        ...
        with st.status('Processando sua varredura...', expanded=True) as status:
            try:
                ...
                if len(df_alvo) == 0:
                    ...
                    # --- BLOCO DE PROTEÇÃO CONTRA COLUNAS FALTANTES ---
                    colunas_protecao = [
                    ...
                    if len(df_hoje) == 0:
                        ...
                        if len(df_hoje) == 0:
                            ...
                            if len(df_final) == 0:
                                ...
                                # SALVA OS RESULTADOS NA MEMÓRIA DO STREAMLIT E EXIBE A TABELA
    ...
    if st.session_state.get('mostrar_tabela', False):
        ...
        # 3. Transforma no formato de texto
