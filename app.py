...
def pagina_scanner():
    ...
    col_nav, espaco, col_rad, col_dat, col_btn_pesq = st.columns([1.2, 1.5, 1.4, 1.3, 1.2])
...
def pagina_resultados():
    ...
    col_nav, espaco, col_rad, col_dat, col_resp, col_btn_pesq = st.columns([1.2, 1.5, 1.4, 1.3, 0.9, 1.2])
